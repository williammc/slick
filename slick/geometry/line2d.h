...
struct Line2DBase {
  ...
  Line2DBase() = default;
  Line2DBase(const PointType& pt1, const PointType& pt2) : pt1_(pt1), pt2_(pt2) {}
  ...
  Scalar squared_perpendicular_distance(const PointType& p) const {
    ...
    const Scalar t = (dy * p[0] - dx * p[1] - pt1_[0] * pt2_[1] +
                     pt1_[1] * pt2_[0]);
  ...
  static Scalar perpen_dist_to_line_signed(
  ...
  static Eigen::Matrix<Scalar, 3, 1> line_equation(
  ...
  static Eigen::Matrix<Scalar, 2, 1> get_a_point(
  ...
  static PointType project_point(
      const PointType& p,
  ...
  static PointType project_point(
      const PointType& p, const PointType& p1,
      const PointType& p2) {
